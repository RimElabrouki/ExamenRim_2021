...
public class DatosBD {
    ...
    public static final Recinto RECINTOS[] = {
        ...
        new Recinto(3, 'E', 540.66, CUIDADORES[3], Jaula.arrayde(Jaula.convertir(JAULAS), new int[]{1, 3, 4, 5, 7, 8, 9, 11})),
        new Recinto(4, 'I', 775.23, CUIDADORES[2], Jaula.arrayde(Jaula.convertir(JAULAS), new int[]{2, 6, 10}))
    };
